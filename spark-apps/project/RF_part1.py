...
spark = SparkSession.builder \
    .appName("LoanDefaultClassification_RF") \
...
pipeline = Pipeline(stages=indexers + encoders + [feature_assembler, rf])
...
sample_df = train_df.sample(withReplacement=False, fraction=0.2)
...
print("Hyperparameters from CV:")
print("maxDepth:", best_rf.getMaxDepth())
print("numTrees:", best_rf.getNumTrees)
print("impurity:", best_rf.getImpurity())

# STEP 8: PREDICTIONS WITH BEST MODEL
print("\n=== STEP 7: PREDICTIONS WITH BEST MODEL ===")
...
# STEP 9: MODEL EVALUATION - TUNED MODEL
print("\n=== STEP 8: MODEL EVALUATION - TUNED MODEL ===")
